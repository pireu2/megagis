...
export async function generateMetadata({
  ...
  const privacyMeta = dict.metadata.privacy || {
    title: locale === "ro" ? "Politica de Confidențialitate | Megagis" : "Privacy Policy | Megagis",
    description: locale === "ro" ? "Politica de confidențialitate și protecția datelor Megagis." : "Megagis privacy policy and data protection.",
  };
  ...
  return {
    ...
    openGraph: {
      title: privacyMeta.title,
      description: privacyMeta.description,
      url: `https://megagis.ro/${locale}/privacy`,
      siteName: "Megagis",
      type: "website",
      ...
      images: [
        {
          ...
          width: 512,
          height: 512,
          alt: "Politica de Confidențialitate Megagis",
        },
      ],
    },
    twitter: {
...
export default async function PrivacyPage({
  ...
  const dict = await getDictionary(locale);
  const legalDict = dict.legal.privacy;
