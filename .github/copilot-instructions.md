...
- **The Vibe:** "Digital Topography." It must feel like a precision instrument.
  - ❌ **Avoid:** Generic corporate templates, standard Bootstrap grids, flat white backgrounds.
  - ✅ **Target:** Asymmetrical layouts (Bento grids), technical aesthetics (monospaced data labels), depth (glassmorphism), and motion.
- **Target Audience:**
...
- **Visual Metaphors:**
  ...
  - **Data Decorators:** Decorate headers with small technical labels like `ID: 04` or `LAT: 44.42` in a monospace font, positioned with absolute precision.
